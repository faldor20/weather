...
(*     testCase "universe exists (╭ರᴥ•́)" <| fun _ ->
    ...
    test "Get meteye Data"{
      let time=DateTime.Now
      let bbox=Mapsui.Geometries.BoundingBox(,,)
      let query={heightPX=255;widthPX=255;baseTime=time;issueTime=time;bbox}
        weather.BOMAPI.getMeteye
